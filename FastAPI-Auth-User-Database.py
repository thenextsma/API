...
fake_users_db = {
    "mustafa": {
        ...
        "disabled": False,
        "data": {"favorite_color": "black", "hobby": "coding", "Location": "UAE"}
    },
    "syed": {
        "username": "syed",
        "full_name": "syed ahmed",
        "email": "syede@example.com",
        "hashed_password": get_password_hash("password2"),
        "disabled": False,
        "data": {"favorite_color": "Navy Blue", "hobby": "Badminton", "Location": "India"}
    }
}
...
async def decode_token(token: str):
    try:
        ...
        return {"username": username, "data": user_data.get("data")}
    except JWTError:
        raise HTTPException(
            status_code=status.HTTP_401_UNAUTHORIZED,
